...
public class Memory extends CommonImpl {
	...
	Memory() {
		...
		rdIns0.setAddress(formatAddress(3, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns1.setAddress(formatAddress(4, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns2.setAddress(formatAddress(10, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns3.setAddress(formatAddress(25, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns4.setAddress(formatAddress(50, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns5.setAddress(formatAddress(100, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns6.setAddress(formatAddress(200, memory_Tag, memory_Index, memory_Offset));
		...
		rdIns7.setAddress(formatAddress(400, memory_Tag, memory_Index, memory_Offset));
